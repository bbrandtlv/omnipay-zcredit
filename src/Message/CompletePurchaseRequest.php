...
class CompletePurchaseRequest extends PurchaseRequest
{
    ...
    {
        $callback = $this->httpRequest->request->all();
        $JSONcallback = json_decode($callback, true);
        if (validateGUID($JSONcallback['GUID'])) {
            throw new InvalidResponseException("Invalid");
        }
